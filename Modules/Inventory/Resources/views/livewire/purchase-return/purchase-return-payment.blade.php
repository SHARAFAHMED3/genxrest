    ...
    <x-modal wire:model="showModal" maxWidth="2xl">
        ...
        <div class="p-6 bg-white dark:bg-gray-800">
            <div class="text-lg font-medium text-gray-900 dark:text-white mb-6">
                Record Refund Payment for {{ $purchaseReturn->reference_no }}
            </div>
            ...
            <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <span class="ml-2 font-semibold text-red-600 dark:text-red-400">{{ currency_format($purchaseReturn->total_amount - $purchaseReturn->paid_amount, restaurant()->currency_id) }}</span>
                    </div>
                    <div>
            ...
            <form wire:submit.prevent="savePayment">
                <!-- Amount -->
                <div class="mb-4">
                    <x-label for="paymentAmount" value="Refund Amount *" class="text-gray-700 dark:text-gray-300" />
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Maximum: {{ currency_format($purchaseReturn->total_amount - $purchaseReturn->paid_amount, restaurant()->currency_id) }}
                    </p>
                </div>

                <!-- Paid On -->
                <div class="mb-4">
                    <x-label for="paymentDate" value="Received On *" class="text-gray-700 dark:text-gray-300" />
