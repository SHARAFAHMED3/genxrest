<div>
    ...
    @if($reportData)
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <!-- Movement Summary -->
            <div class="mb-6">
                <h4 class="text-md font-semibold text-gray-900 dark:text-white mb-4">Movement Summary</h4>
            ...
            <div class="mb-6">
                <h4 class="text-md font-semibold text-gray-900 dark:text-white mb-4">@lang('cashregister::app.countedCash') (@lang('cashregister::app.denominations'))</h4>
            ...
            <div class="mb-6">
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-md font-semibold text-gray-900 dark:text-white">Discrepancy Summary</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                Expected: {{ currency_format($reportData['expected_cash'], restaurant()->currency_id) }} | 
                                Counted: {{ currency_format($reportData['counted_cash'], restaurant()->currency_id) }}
                            </p>
                        </div>
                        <div class="text-right">
